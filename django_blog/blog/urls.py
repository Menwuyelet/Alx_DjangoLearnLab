...
from .views import list_comment, CommentCreateView, CommentUpdateView, CommentDeleteView, search_posts, posts_by_tag
...
urlpatterns = [
    ...
    path('tags/<tag_name>/', posts_by_tag, name= 'posts_by_tag'),
]